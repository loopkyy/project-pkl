		...
		<div class="table-responsive">
			...
			<table id="example1" class="table table-bordered table-striped">
				<thead>
					<tr>
						...
						<th>Tgl Lahir</th>
						<th>Jekel</th>
						<th>Agama</th> <!-- Kolom Agama Ditambahkan -->
						<th>Keluarga</th>
						<th>Aksi</th>
					</tr>
				</thead>
				<tbody>
					...
					<?php
              $no = 1;
			  $sql = $koneksi->query("SELECT l.id_lahir, l.nama, l.tgl_lh, l.jekel, l.agama, k.no_kk, k.kepala 
					FROM tb_lahir l 
            ...
            ?>
					...
					<tr>
						...
						<td>
							<?php echo $data['agama']; ?> <!-- Tampilkan Agama -->
						</td>
						<td>
							<?php echo $data['no_kk']; ?> -
